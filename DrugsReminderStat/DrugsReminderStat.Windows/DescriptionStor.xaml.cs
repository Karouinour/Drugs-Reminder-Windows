...
namespace DrugsReminderStat
{
    ...
    /// </summary>
    public sealed partial class DescriptionStor : Page
    {
        public DescriptionStor()
        {
        ...
        private void btnAdduser(object sender, TappedRoutedEventArgs e)
        {
        ...
        private void BtnlistStor(object sender, TappedRoutedEventArgs e)
        {
